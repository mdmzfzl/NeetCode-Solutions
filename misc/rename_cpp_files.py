...
# Define the source directory containing subdirectories with C++ files
source_directory = '/home/larcade/Downloads/NeetCodeee'
                ...
                if filename.endswith('.cpp'):
                    with open(file_path, 'r') as file:
                        ...
                        if match:
                            ...
                            problem_name = match.group(2).strip().replace(' ', '-').lower()
                            new_filename = f"{problem_number}-{problem_name}.cpp"
